...
async def analyze_tweet(url):
    ...
    prompt = (
        ...
        "sensitive, political, false information, or no flagging then give the explanation and YOU MUST RETURN PURE "
        "HTML USING TAGS LIKE <P>, <STRONG>, <UL> AND OTHERS WITHOUT INCLUDING ANY HEADERS OR CSS. IF YOU DON'T RETURN PURE "
        "HTML I WILL LOSE A LOT OF MONEY AND I WILL BECOME VERY SAD, THE WHOLE PROMPT MUST BE HTML"
    )
